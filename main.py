...
class AutomataGraph(Frame):
    ...
    def draw_automata(self):
        ...
        # Agrega nodos y transiciones al grafo
...
def menuOpciones():
  while True:
    ...
    opcion ={
              1: ingresarAutomata, 2: validarCadena, 3: unionAutomatas, 4: interseccionAutomatas, 5: reversoAutomata, 6: complementoAutomata, 7: graficarAutomata
            }
